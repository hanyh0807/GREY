...
class simul():
    def __init__(self, num_initial, drug = 'Afatinib', forexp=False, start_process = True, mb_size = 8, y_scaling=False, use_randsign=False, max_task_num=10000, name=None, scale=5):
        ...
        self.adjmat = pd.read_csv(os.path.dirname(os.path.abspath(__file__))+'/palbociclib_network.csv', header=0,index_col=0)
        ...
        self.weightmat_link_idx = Array('d', 3000) #maximum 500 indices
